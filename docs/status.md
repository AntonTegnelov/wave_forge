...
- It runs headless on a software Vulkan device (Mesa llvmpipe), which is enough for correctness tests in containers without a GPU. Performance work needs real hardware.
