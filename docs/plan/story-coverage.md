...
| N11 My own history | region jobs, curves, categories, levels, the atlas, tables given and read back from GDScript | stages that realise a table's rows, rasterised curves, the example project ([#72](https://github.com/AntonTegnelov/wave_forge/issues/72), [#98](https://github.com/AntonTegnelov/wave_forge/issues/98)) |
