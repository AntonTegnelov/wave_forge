...
| N3 Place my own scene | Scatter with spacing across seams, scenes bound to kinds in Godot as MultiMeshes or nodes, and in Bevy as entities | promotion near the player ([#44](https://github.com/AntonTegnelov/wave_forge/issues/44)), rule resources ([#48](https://github.com/AntonTegnelov/wave_forge/issues/48)) |
