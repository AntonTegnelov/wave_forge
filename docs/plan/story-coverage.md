...
| N3 Place my own scene | Scatter with spacing across seams, scenes bound to kinds in Godot as MultiMeshes or nodes | promotion near the player and Bevy's side ([#44](https://github.com/AntonTegnelov/wave_forge/issues/44)), rule resources ([#48](https://github.com/AntonTegnelov/wave_forge/issues/48)) |
