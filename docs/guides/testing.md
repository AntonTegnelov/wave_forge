...
| Godot frozen directory | `wave_forge_godot/godot/verify_frozen.gd` | With `frozen_directory` set, walking away drops the origin's frozen trees into a file there, and walking back gives the origin the trees it had | Yes, and a Godot binary |
