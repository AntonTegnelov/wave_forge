...
# draws a wide view at the ground's levels of detail and checks no gap opens between chunks
# (developer tool).
#
...
exec "${GODOT:-godot}" --rendering-driver opengl3 --path "$here/godot" --script render_lods.gd
