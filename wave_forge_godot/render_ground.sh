...
# timing grass; then draws trees with the vegetation shader and checks they move in the wind
# (developer tool).
#
...
exec "${GODOT:-godot}" --rendering-driver opengl3 --path "$here/godot" --script render_wind.gd
